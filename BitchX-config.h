 ...
 */
#define DEFAULT_SERVER	"[HybridNet] "\
			"irc.bitchx.com "\
			"[efnet] "\
			"irc.total.net "\
			"ircd.c-com.net "\
			...
			"dalnet.nac.net "\
			"radius2.stlnet.com "\
			"dsle01781.adsl.telusplanet.net "\
			"dalnet.webbernet.net "\
			"echoes.qis.net "\
			"[Undernet US] "\
			"irc.cic.net "\
			"irc.erols.com "\
...
#define DEFAULT_NOTIFY_INTERVAL 15000
...
#define DEFAULT_JOIN_NEW_WINDOW_TYPE "new hide swap last"
#define DEFAULT_QUERY_NEW_WINDOW 0
#define DEFAULT_QUERY_NEW_WINDOW_TYPE "new hide swap last"
...
#if defined(WINNT) || defined(__EMX__)
#define WANT_DLL	1
#elif defined(_AIX) || defined(__OPENNT)
#undef WANT_DLL
#else
#undef WANT_DLL
#endif
